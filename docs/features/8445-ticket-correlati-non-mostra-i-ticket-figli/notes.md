...
- Perdita accettata: `searchable()` e `filterable()` sul campo "Ticket correlati" — non esistono su `HasMany` e la loro presenza produce un `BadMethodCallException`, cioè un 500 sul detail di **ogni** ticket. Coperto da test di regressione.
