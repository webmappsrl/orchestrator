...
<head>
    <meta charset="UTF-8">
    <title>Selettore Activity Customer Details</title>
    <style>
        body {
...
<body>
    <div class="activity-selector-container">
        <div class="selector-title">📊 Activity Customer Details</div>
        
        <form method="POST" action="/set-activity-customer-details-filters" class="selector-wrapper">
            @csrf
            ...
            <div class="selector-group">
                <label class="selector-label" for="customer-id">Customer:</label>
                <select name="customer_id" id="customer-id" class="customer-select" required>
                    <option value="">-- Seleziona un customer --</option>
