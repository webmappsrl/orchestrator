                ...
                <td class="wrapper">
                    ...
                    <main class="service-description">
                        ...
                        @if ($quote->products->count() > 0)
                            ...
                            <div class="products-and-services table">
                                <thead>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td class="aligned-right">{{ number_format($quote->getTotalPrice(), 2, ',', '.') }} €
                                </td>
                            </tr>
                        </thead>
                        <thead>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td class="aligned-right">{{ number_format($quote->discount ?? 0, 2, ',', '.') }} €
                                </td>
                            </tr>
                        </thead>
                        <thead>
