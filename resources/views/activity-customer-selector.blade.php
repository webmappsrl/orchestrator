...
<head>
    <meta charset="UTF-8">
    <title>Selettore Activity Customer</title>
    <style>
        body {
...
<body>
    <div class="activity-selector-container">
        <div class="selector-title">📊 Activity Customer Dashboard</div>
        
        <form method="POST" action="/set-activity-customer-filters" class="selector-wrapper">
            @csrf
            ...
            <div class="selector-group">
                <label class="selector-label" for="customer-filter">Customer:</label>
                <input type="text" name="customer_filter" id="customer-filter" class="customer-input" 
                       value="{{ $selectedCustomerFilter }}" placeholder="Filtra per nome customer...">
            </div>
