...
<head>
    <meta charset="UTF-8">
    <title>Selettore Activity Organizations</title>
    <style>
        body {
...
<body>
    <div class="activity-selector-container">
        <div class="selector-title">📊 Activity Organizations Dashboard</div>
        
        <form method="POST" action="/set-activity-organizations-filters" class="selector-wrapper">
            @csrf
            ...
            <div class="selector-group">
                <label class="selector-label" for="organization-filter">Organization:</label>
                <input type="text" name="organization_filter" id="organization-filter" class="organization-input" 
                       value="{{ $selectedOrganizationFilter }}" placeholder="Filtra per nome organizzazione...">
            </div>
