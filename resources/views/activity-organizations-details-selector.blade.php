...
<head>
    <meta charset="UTF-8">
    <title>Selettore Activity Organizations Details</title>
    <style>
        body {
...
<body>
    <div class="activity-selector-container">
        <div class="selector-title">📊 Activity Organizations Details</div>
        
        <form method="POST" action="/set-activity-organizations-details-filters" class="selector-wrapper">
            @csrf
            ...
            <div class="selector-group">
                <label class="selector-label" for="organization-id">Organization:</label>
                <select name="organization_id" id="organization-id" class="organization-select" required>
