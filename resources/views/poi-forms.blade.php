                ...
                <div class="ml-12">
                    <div class="mt-12 text-gray-600 dark:text-gray-400 text-sm">
                        ...
                        <p>la configurazione dei poi è un array di object.
                            Ogni object ha la seguente struttura, il primo form è quello di default.
                        </p>
                        <code>
                            { <br>
                            <span class="comment">**"id": identificativo che identifica il form associato ai dati che
                                verranno raccolti**</span><br>
                            <span style="margin-left:10px">
                                "id": "id_del_form"<br>
                            </span>
                            <span class="comment">**"label": accetta un dizionario chiave valore con chiave la lingua e
                                valore la traduzione associata oppure una stringa**</span><br>
                            <span style="margin-left:10px">
                                "label": {
                            ...
                            <span class="comment">**"fields": è un array di object che rappresentano i fields dei
                                forms**</span><br>
                            <span style="margin-left:10px">
                                "fields":[<br>
                            </span>
                            <span class="workin">**IL PRIMO FIELD DI OGNI FORM DEVE ESSERE SEMPRE COL "name":"title"
                                PERCHè IL RISULTATO SARA' USATO PER DARE IL NOME AL POI**</span><br>
                            <span style="margin-left:10px">
                                {
