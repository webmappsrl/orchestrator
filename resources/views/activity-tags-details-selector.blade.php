...
<head>
    <meta charset="UTF-8">
    <title>Selettore Activity Tags Details</title>
    <style>
        body {
...
<body>
    <div class="activity-selector-container">
        <div class="selector-title">📊 Activity Tags Details</div>
        
        <form method="POST" action="/set-activity-tags-details-filters" class="selector-wrapper">
            @csrf
            ...
            <div class="selector-group">
                <label class="selector-label" for="tag-id">Tag:</label>
                <select name="tag_id" id="tag-id" class="tag-select" required>
