...
<head>
    <meta charset="UTF-8">
    <title>Selettore Activity User</title>
    <style>
        body {
...
<body>
    <div class="activity-selector-container">
        <div class="selector-title">📊 Activity User Dashboard</div>
        
        <form method="POST" action="/set-activity-user-filters" class="selector-wrapper">
            @csrf
